...
package orgranizationv1connect

import (
	v1 "app/gen/proto/organization/v1"
...
const (
	...
	OrganizationName = "auth.v1.Organization"
)
...
const (
	...
	OrganizationCreateOrganizationProcedure = "/auth.v1.Organization/CreateOrganization"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	organizationServiceDescriptor                  = v1.File_proto_organization_v1_organization_proto.Services().ByName("Organization")
	organizationCreateOrganizationMethodDescriptor = organizationServiceDescriptor.Methods().ByName("CreateOrganization")
)

// OrganizationClient is a client for the auth.v1.Organization service.
...
// NewOrganizationClient constructs a client for the auth.v1.Organization service. By default, it
...
// CreateOrganization calls auth.v1.Organization.CreateOrganization.
...
// OrganizationHandler is an implementation of the auth.v1.Organization service.
...
func NewOrganizationHandler(svc OrganizationHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/auth.v1.Organization/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOrganizationHandler) CreateOrganization(context.Context, *connect.Request[v1.RequestOrganization]) (*connect.Response[v1.ResponseOrganization], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("auth.v1.Organization.CreateOrganization is not implemented"))
}
